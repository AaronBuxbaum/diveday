 ...
 *
 * The attribute names are a contract (src/lib/embed-snippets.ts pins them). Every
 * snippet works with this file missing: a button is a link, a framed kind is an
 * empty <div>. What this adds is the frame, its height, the host page's colour
 * and face when the look is "site", and the lightbox sheet.
 */
(() => {
  ...
  function lightbox(el) {
    ...
    el.addEventListener("click", (event) => {
      ...
      sheet.style.cssText =
        "position:relative;width:100%;max-width:720px;height:min(92vh,900px);background:#fff;border-radius:16px 16px 0 0;overflow:hidden";
