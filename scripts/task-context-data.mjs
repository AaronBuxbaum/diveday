...
export const areas = {
  ...
  notifications: {
    ...
    validate: [
      "pnpm test src/lib/notifications/index.test.ts src/lib/notifications/email.test.ts src/lib/notifications/sms.test.ts src/lib/notifications/events.test.ts src/lib/notifications/webhook.test.ts src/db/notifications.test.ts --reporter=dot",
      "pnpm check",
    ],
  },
  reviews: {
