...
/**
 * The words and tone a buddy alert wears (ADR 20260804-buddy-pairs). The lib
 ...
 * alert fires on an awaiting buddy too, and it must not put words in the
 * crew's mouth (dive-domain review, 2026-08-04).
 */
const BUDDY_ALERT_KEYS: Record<BuddyAlert, StaffMessageKey> = {
  separated_dock: "shared.buddyPair.separatedDock",
  separated_after_dive: "shared.buddyPair.separatedAfterDive",
};
