...
const fareharbor: MigrationGuide = {
  ...
  context: [
    ...
    "So there are two honest ways DiveDay fits a FareHarbor shop, below: keep FareHarbor for the storefront and add the dive day it can't run, or take the booking in DiveDay too and leave the per-booking fee behind. Whichever you pick, you bring your divers across the same way — and the cert checks, waivers, and roll-call manifest hold either way.",
  ],
