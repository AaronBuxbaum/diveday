...
export async function seedGear(
  ...
  const fleet: Array<{
    ...
    { kind: "mask", label: "Mask #1" },
    { kind: "mask", label: "Mask #2" },
    { kind: "mask", label: "Mask #3" },
    { kind: "fins", label: "Fins #1", size: "S" },
    { kind: "fins", label: "Fins #2", size: "M" },
    { kind: "fins", label: "Fins #3", size: "L" },
    {
      kind: "dive_computer",
      label: "Computer #1",
