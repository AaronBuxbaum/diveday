...
/**
 * Puts translated words above the password-reset page's `error.tsx`. A layout
...
export default async function ResetPasswordTokenLayout({ children }: { children: ReactNode }) {
  return (
