 ...
 * `error.tsx` for the notification opt-out page linked from every message DiveDay sends (ADR
 ...
 */
export default function UnsubscribeTokenLayout({ children }: { children: ReactNode }) {
  return (
