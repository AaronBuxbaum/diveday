...
export function TripActions({
  ...
  return (
    ...
    <fieldset className="mt-4 flex flex-wrap items-baseline gap-x-3 gap-y-1 text-sm">
      ...
      {/* No "Get directions" here. A door to a maps app, sitting in the
          plan-and-share row before a diver has booked anything, was a third
          button competing with the one that matters on this page. Removed
          2026-08-13 at the product owner's call; the shop's own address and
          map live on the thread, where a diver who has a seat reads them. */}
