 ...
 * diver who had already paid would ever reach it. That component still exists
 * and still renders on `/ready`, which is where a briefing belongs: reading for
 * the night before, not the pitch.
 *
