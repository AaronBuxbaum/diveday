...
import type { PrivateNoteAction } from "@/components/PrivateNoteForm";
...
import { DiverFacts, type ManifestNote, PersonSheet } from "./PersonSheet";
import {
  ROLL_CALL_ROW_TONE,
                ...
                <div className="flex items-start">
                  ...
                  <details className="group/person min-w-0 flex-1">
                    ...
                    <PersonSheet
                      ...
                      sharedAdvisoryTexts={sharedAdvisoryTexts}
                      notes={bookingNotes}
                      capsuleKind={capsuleKind}
                      rollCallAction={rollCallAction}
                      addPrivateNoteAction={addPrivateNoteAction}
                      rollCallButtonCopy={rollCallButtonCopy(diver.bookingId)}
                      t={t}
                    />
                  </details>
