 ...
 * for the giver's own page (ADR 20260803-error-boundary-copy-bridge).
 *
 ...
 * locales' boundary copy crosses to the client and `ErrorBoundaryIntlProvider`
 * picks between them from `<html lang>` — see src/app/ready/[token]/layout.tsx
 * for the full reasoning.
 */
export default function GiftTokenLayout({ children }: { children: ReactNode }) {
  return (
