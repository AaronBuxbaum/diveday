...
export const metadata: Metadata = {
  ...
  description:
    "Running your dive shop from a spreadsheet? DiveDay reads the sheet you already keep (your divers, their certification records, and their sizes) and adds what a spreadsheet cannot: readiness checked at the dock, the day's blocker queue, and booking and waivers your divers do themselves.",
  ...
  openGraph: {
    ...
    title: "Move your dive shop off spreadsheets — DiveDay",
    description:
      "Bring the sheet you already keep (divers, certification records, sizes) and add what a spreadsheet cannot: readiness checked at the dock, the day's blocker queue, and booking and waivers your divers do themselves.",
