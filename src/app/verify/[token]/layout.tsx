...
/**
 * Puts translated words above the email-verification page's `error.tsx`. A layout
...
export default async function VerifyTokenLayout({ children }: { children: ReactNode }) {
  return (
