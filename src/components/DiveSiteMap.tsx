 ...
 * than a detail.
 *
 * **Restored, not new.** Slice 7c deleted the swipeable briefing deck this used
 * to sit inside, and took this with it — which left the staff route editor
 * drawing something no diver could ever read, against the one sentence ADR
 * 20260809-shop-drawn-dive-routes rests on. It comes back on its own, in the
 * pitch, as one figure per site rather than one card per tank: the deck was the
 * thousand pixels the thread ADR objected to, and a single drawn line is not.
 */
