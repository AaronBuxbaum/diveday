 ...
 * a phone, three from `sm` — so a field holding one photo (a course's hero, a
 * trip's arrival photo) draws it at the size a gallery's cells are, and a
 * gallery under it lines up with it. A field in a half column (a dive site's
 * map and route stills) lets the photo take the column instead.
 */
 ...
 * the caption turn danger, the photo dims, and the corner tick fills: the
 ...
 * the tick. `RemovablePhoto.test.tsx` refuses a `StoredPhoto` beside a
 * checkbox anywhere else.
 *
  ...
  return (
    <label className="relative block cursor-pointer">
      ...
      <StoredPhoto
        src={url}
        alt=""
        className="h-24 w-full rounded-lg border-2 border-border transition peer-checked:border-danger peer-checked:opacity-50 peer-focus-visible:focus-ring"
