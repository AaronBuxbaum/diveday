CREATE TABLE "push_subscriptions" (
	...
	"auth" text NOT NULL,
	"trip_starts_at" timestamp with time zone NOT NULL,
...
CREATE INDEX "push_subscriptions_starts_at_idx" ON "push_subscriptions" ("trip_starts_at");--> statement-breakpoint
