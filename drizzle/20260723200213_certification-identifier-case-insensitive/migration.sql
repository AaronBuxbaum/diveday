...
CREATE UNIQUE INDEX "specialty_certifications_shop_agency_identifier_unique" ON "specialty_certifications" ("shop_id","agency",lower("identifier")) WHERE "deleted_at" is null;