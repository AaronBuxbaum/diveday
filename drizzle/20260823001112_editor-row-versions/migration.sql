ALTER TABLE "courses" ADD COLUMN "updated_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "dive_sites" ADD COLUMN "updated_at" timestamp with time zone;--> statement-breakpoint
...
-- generate is clean; the tooling trap itself is filed separately.
