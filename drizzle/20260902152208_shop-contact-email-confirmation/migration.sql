...
ALTER TABLE "shop_contact_email_confirmation_tokens" ADD CONSTRAINT "shop_contact_email_confirmation_tokens_shop_id_shops_id_fkey" FOREIGN KEY ("shop_id") REFERENCES "shops"("id");