...
| E2E tests | Playwright flows + BackstopJS visual regression | [0002](decisions/0002-toolchain.md), [20260729 Backstop](decisions/20260729-backstop-visual-regression.md), [20260719 MSW scope](decisions/20260719-msw-offline-sync-only.md) |
...
backstop/       # Backstop stateful visual journeys and hooks
backstop_data/  # committed reference PNGs; reports/captures are ignored
