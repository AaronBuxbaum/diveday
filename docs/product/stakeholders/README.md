...
| Privacy & communications | [privacy-and-communications.md](privacy-and-communications.md) | Privacy counsel, Resend (sender domain) | Phase 0 | H-02, H-04 (incident response), H-09 |
...
Three clocks start ticking on contact, not on need — start all three in the same week:
...
3. **A boat day for V-02** ([dive-operations.md](dive-operations.md)) — needs weather, a captain,
...
- **Privacy & comms:** verify the Resend production sender; draft the H-09 consent policy for
  counsel review.
