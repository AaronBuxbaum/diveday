...
> [shipped.md](../shipped.md). What didn't: **gift cards**, **private/buyout charters**, and
> **diver-selectable upsells at checkout** now live in
> [future-features.md](../future-features.md), which is where to plan them from; **multi-currency**
> is recorded there too as a don't-build-ahead-of-demand entry. Per-feature rough edges on the
...
**Not built, and now tracked in [future-features.md](../future-features.md)** — each is closer to a
...
shipped its feature, which stays the place to look; [future-features.md](../future-features.md) lists
where.
