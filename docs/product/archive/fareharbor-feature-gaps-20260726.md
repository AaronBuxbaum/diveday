...
> [roadmap.md](../features/roadmap.md#not-scheduled--candidate-subsystems), which is where to plan them from.
...
> items that survive review move to [roadmap.md](../features/roadmap.md).
...
**Not built, and now tracked in [roadmap.md](../features/roadmap.md#not-scheduled--candidate-subsystems)** — each is closer to a
...
shipped its feature, which stays the place to look; [roadmap.md](../features/roadmap.md#not-scheduled--candidate-subsystems) lists
where.

Nothing on this list is open work. Plan from [roadmap.md](../features/roadmap.md) and
[roadmap.md](../features/roadmap.md#not-scheduled--candidate-subsystems).
