...
- **Waiver evidence:** the first release keeps immutable local records with typed consent; it does
  not claim cryptographic non-repudiation. The unresolved policy work is H-01 through H-03. A
  contact-imported record (`signatureMethod: "imported"`, H-17) trusts a prior shop's own acceptance
  instead of local consent capture — a distinct, separately decided evidence source; see
