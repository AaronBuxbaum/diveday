...
3. **Gift cards** and **the private/buyout charter workflow** — real revenue levers, but each is
   ...
   separate effort.
4. **Multi-currency** — leave until international demand is real. (**SEO structured data on booking
   pages** shipped 2026-07-29, as did **promo codes** at #2 and the internal **reviews display**;
   what remains open on this list is rental add-ons at #1, gift cards and buyout charters at #3, and
   multi-currency here.)
