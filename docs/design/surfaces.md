...
**Proposed 2026-09-19** ([ADR 20260919-one-idea](../architecture/decisions/20260919-one-idea.md), [canvas](canvases/20260919-one-idea/README.md)): the home is the thing the app is — the day under the sky at the shop's own hour, the boats on the hours they leave and the needs under each (I · Tide); today's boats as coloured hulls with their seats, stacked, the shop's card last (II · Deck); the shop's own water with today's tracks and the day as a sheet over it (III · Chart). No tabs, no More, no dock under any of them. **Decided 2026-09-19 (H-88): I · Tide** — the home is the day: the sky at the shop's own hour, the boats on the hours they leave, the tide under them, a line for now, and the needs under each departure.
...
**Proposed 2026-09-19** ([ADR 20260919-one-idea](../architecture/decisions/20260919-one-idea.md), [canvas](canvases/20260919-one-idea/README.md)): the departure is its hour with the strip zoomed to the voyage (I), its hull with every seat's initials and state (II), or its voyage on the chart with the legs as a timeline (III); one page, the roll call's tap untouched beneath. **Decided 2026-09-19 (H-88): Tide's hour with Deck's hull inside it** — the departure opens with its time over the sky and the strip zoomed to the voyage, then the seats laid out bow to stern.
...
**Proposed 2026-09-19** ([ADR 20260919-one-idea](../architecture/decisions/20260919-one-idea.md), [canvas](canvases/20260919-one-idea/README.md)): the roll call is the same picture as boarding — under Deck it is tapping the seats on the hull, under Tide and Chart the count leads and the names follow, one circle per name; glare is the crew's word in every case. **Decided 2026-09-19 (H-88): Tide**, so the count leads and the names follow, with the hull above them on a boat departure.
...
**Proposed 2026-09-19** ([ADR 20260919-one-idea](../architecture/decisions/20260919-one-idea.md), [canvas](canvases/20260919-one-idea/README.md)): Harbor's face and the shop's colour over the idea's own front page — the next boats led by their time under the noon sky and the week as seven days (I), the boat you are about to book with its empty seats visible (II), where we go on the shop's chart (III). **Decided 2026-09-19 (H-88): Tide** — the shop's name and the day over its own sky, the next boats led by their time, the week as seven days with seats left.
