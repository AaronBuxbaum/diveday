...
| 16e — the booking page bounded: tiles and a door, "Also worth a look" (D01), the intent question (D12), the rusty diver's offers (D18); the composition test that holds the length | open | — | — |
