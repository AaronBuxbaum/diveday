...
| Focus ring | 3px outline at a 2px offset, so it reaches **5px** outside the box | `:where(a, button, …):focus-visible` |
...
- **Rule.**
  ...
  - Every focusable thing shows the global ring, and nothing clips it.
